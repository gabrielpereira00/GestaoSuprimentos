                    ...
                    <div class="row">
                        ...
                        <div class="accordion-item">
                           ...
                           <div class="accordion-item">
                            ...
                            <ul class="none Texto">
                                <i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Quantos clientes são atendidos pelo fornecedor?
                                <br>
                                <i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Quanto de sua capacidade produtiva já está comprometida com eles?
                                <br>
                                <i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Seus clientes atuam no mesmo segmento que minha organização?
                                <br>
                                <i class="fa fa-arrow-right CorVerdeClaroEstado"></i> O que esses clientes dizem sobre a parceria?
                                <br>
                                <i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Com base nessas informações, é possível ter um panorama geral de como está o desempenho do fornecedor com seus clientes e como a sua demanda se encaixaria nesse cenário.
                            </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <br>
                            ...
                            <div class="accordion-item accordion-item1">
                                <h2 class="accordion-header" id="Item01">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseone" aria-expanded="false" aria-controls="flush-collapseone">
                                        <strong>1.2.1 Celeridade na contratação de bens e serviços comuns</strong>
                                    </button>
                                </h2>
                                <div id="flush-collapseone" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                            ...
                            <div class="accordion-item accordion-item1">
                                <h2 class="accordion-header" id="Item02">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetwo" aria-expanded="false" aria-controls="flush-collapsetwo">
                                        <strong>1.2.2 Redução no preço das contratações</strong>
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item accordion-item1">
                                <h2 class="accordion-header" id="Item03">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetree" aria-expanded="false" aria-controls="flush-collapsetree">
                                        <strong>1.2.3 Não exigência de habilitação prévia</strong>
                                    </button>
                                </h2>
                                <div id="flush-collapsetree" class="accordion-collapse collapse" aria-labelledby="Item03" data-bs-parent="#AccordionFase03">
                                    <div class="accordion-body">
                            ...
                            <div class="accordion-item accordion-item1">
                                <h2 class="accordion-header" id="Item04">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefour" aria-expanded="false" aria-controls="flush-collapsefour">
                                        <strong>1.2.4 Aumento no número de concorrentes</strong>
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item accordion-item1">
                                <h2 class="accordion-header" id="Item05">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-collapsefive">
                                        <strong>1.2.5 Transparência</strong>
                                    </button>
                                </h2>
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse001" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
...
<ol type="I" class="Texto">
    ...
    <li> Instituir e disciplinar o procedimento e as competências para apuração de irregularidades cometidas por pessoas físicas e jurídicas nas licitações, fornecimentos ou execuções contratuais no âmbito da Administração Pública Estadual.</li>
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse002" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse003" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse004" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse005" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                                ...
                                <div id="flush-collapse006" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
